...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:variable name="frame_width">5cm</xsl:variable>
	...
	<xsl:template match="lots">
		<document>
			<template pageSize="(5cm,2.5cm)" title="Address list" author="Generated by Odoo">
				<pageTemplate id="all">
					<pageGraphics/>
	...
	<xsl:template match="lot-line" mode="story">
            <blockTable style="mytable" colWidths="5cm,0cm">
                <tr>
                    <td>
                        <barCode  widht="5cm" height="1.2cm" code="EAN13"><xsl:value-of select="ean13" /></barCode>
                    </td>
                    <td>
                    </td>
                </tr>
