...
class costos_produccion(models.Model):
	...
	def get_total_unidades_producidas_extraccion(self):
		...
		self.env.cr.execute(""" 
			select sum(ingreso) as ingreso,sum(round(credit,2)) as credit from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_extraccion.id) + """}',
	...
	def get_total_unidades_producidas_tri(self):
		...
		self.env.cr.execute(""" 
			select sum(ingreso) as ingreso,sum(round(credit,2)) as credit from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_trituracion.id) + """}',
	...
	def get_prod_proc_anter_cal(self):
		...
		print """ 
			select sum(ingreso) as ingreso,sum(round(credit,2)) as credit from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_intermedia.id) + """}',
	...
	def get_total_unidades_producidas_cal(self):
		...
		self.env.cr.execute(""" 
			select sum(ingreso) as ingreso,sum(round(credit,2)) as credit from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_calcinacion.id) + """}',
	...
	def get_total_unidades_producidas_mic(self):
		...
		self.env.cr.execute(""" 
			select sum(ingreso) as ingreso,sum(round(credit,2)) as credit from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_micronizado.id) + """}',
	...
	def crear_trituracion(self):
		...
		data = {
			...
			'account_id':par.product_costos_extraccion.id,
			'debit':0,
			'credit':self.prod_proc_anter_tri,
			'move_id':mkl.id,
		}		
		self.env['account.move.line'].create(data)
		...
		data = {
			...
			'debit':0,
			'credit':t.monto + self.prod_proc_anter_tri,
			'move_id':mkl.id,
		}		
		self.env['account.move.line'].create(data)
	...
	def crear_calcinacion(self):
		...
		data = {
			...
			'account_id':par.aa_variacion_almacenada_intermedia.id,
			'debit':self.prod_proc_anter_cal,
			'credit':0,
			'move_id':mkl.id,
		}		
		self.env['account.move.line'].create(data)
		data = {
			...
			'account_id':par.product_costos_intermedia.id,
			'debit':0,
			'credit':self.prod_proc_anter_cal,
			'move_id':mkl.id,
		}		
		self.env['account.move.line'].create(data)
		...
		data = {
			...
			'debit':0,
			'credit':t.monto + self.prod_proc_anter_cal,
			'move_id':mkl.id,
		}		
		self.env['account.move.line'].create(data)
	...
	def crear_micronizado(self):
		...
		data = {
			...
			'account_id':par.aa_variacion_almacenada_calcinacion.id,
			'debit':self.prod_proc_anter_mic,
			'credit':0,
			'move_id':mkl.id,
		}		
		self.env['account.move.line'].create(data)
		data = {
			...
			'account_id':par.product_costos_calcinacion.id,
			'debit':0,
			'credit':self.prod_proc_anter_mic,
			'move_id':mkl.id,
		}		
		self.env['account.move.line'].create(data)
		...
		data = {
			...
			'debit':0,
			'credit':t.monto + self.prod_proc_anter_mic,
			'move_id':mkl.id,
		}		
		self.env['account.move.line'].create(data)
	...
	def create(self,vals):
		...
		self.env.cr.execute( """
		select substring(cuenta,1,3),sum(round(debe-haber,2)) from get_hoja_trabajo_detalle_registro(false,"""+period_txt+ ""","""+period_txt+ """)
	...
	def get_extra_tt_ton(self):
		...
		self.env.cr.execute(""" 
			select sum(salida) as ingreso,sum(round(credit,2)) as credit from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_extraccion.id) + """}',
			'{""" + str(parametros.location_virtual_produccion.id) + """,""" + str(parametros.location_existencias_extraccion.id) + """}') 
			where (ubicacion_origen = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_destino = """ + str(parametros.location_existencias_extraccion.id) + """)
			or (ubicacion_destino = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_origen = """ + str(parametros.location_existencias_extraccion.id) + """)
			""")
	...
	def get_tritu_tt_ton(self):
		...
		self.env.cr.execute(""" 
			select sum(salida) as ingreso,sum(round(credit,2)) as credit from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_trituracion.id) + """}',
			'{""" + str(parametros.location_virtual_produccion.id) + """,""" + str(parametros.location_existencias_trituracion.id) + """}') 
			where (ubicacion_origen = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_destino = """ + str(parametros.location_existencias_trituracion.id) + """)
			or (ubicacion_destino = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_origen = """ + str(parametros.location_existencias_trituracion.id) + """)
			""")
	...
	def get_tritu_ini_imp(self):
		...
		if len(periodo_anterior )>0:
			...
			self.env.cr.execute(""" 
				select saldov as ingreso,(round(credit,2)) as credit from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_trituracion.id) + """}',
				'{""" + str(parametros.location_virtual_produccion.id) + """,""" + str(parametros.location_existencias_trituracion.id) + """}') 
				where (ubicacion_origen = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_destino = """ + str(parametros.location_existencias_trituracion.id) + """)
				or (ubicacion_destino = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_origen = """ + str(parametros.location_existencias_trituracion.id) + """)
				""")
	...
	def get_tritu_ven_ton(self):
		...
		var_txt_con = """ 
			select (salida) as ingreso,(round(credit,2)) as credit,ubicacion_destino ,ubicacion_origen from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_trituracion.id) + """}',
			'{"""
	...
	def get_piedra_pro_imp(self):
		...
		self.env.cr.execute(""" 
			select sum(ingreso) as ingreso,sum(round(debit,2)) as credit from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_intermedia.id) + """}',
			'{""" + str(parametros.location_virtual_produccion.id) + """,""" + str(parametros.location_existencias_intermedia.id) + """}') 
			where (ubicacion_origen = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_destino = """ + str(parametros.location_existencias_intermedia.id) + """)
			or (ubicacion_destino = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_origen = """ + str(parametros.location_existencias_intermedia.id) + """)
			""")
	...
	def get_piedra_tt_ton(self):
		...
		self.env.cr.execute(""" 
			select sum(salida) as ingreso,sum(round(credit,2)) as credit from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_intermedia.id) + """}',
			'{""" + str(parametros.location_virtual_produccion.id) + """,""" + str(parametros.location_existencias_intermedia.id) + """}') 
			where (ubicacion_origen = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_destino = """ + str(parametros.location_existencias_intermedia.id) + """)
			or (ubicacion_destino = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_origen = """ + str(parametros.location_existencias_intermedia.id) + """)
			""")
	...
	def get_piedra_ini_imp(self):
		...
		if len(periodo_anterior )>0:
			...
			self.env.cr.execute(""" 
				select saldov as ingreso,(round(credit,2)) as credit from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_intermedia.id) + """}',
				'{""" + str(parametros.location_virtual_produccion.id) + """,""" + str(parametros.location_existencias_intermedia.id) + """}') 
				where (ubicacion_origen = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_destino = """ + str(parametros.location_existencias_intermedia.id) + """)
				or (ubicacion_destino = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_origen = """ + str(parametros.location_existencias_intermedia.id) + """)
				""")
	...
	def get_piedra_ven_ton(self):
		...
		var_txt_con = """ 
			select (salida) as ingreso,(round(credit,2)) as credit, ubicacion_destino, ubicacion_origen from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_intermedia.id) + """}',
			'{"""
	...
	def get_calci_tt_ton(self):
		...
		self.env.cr.execute(""" 
			select sum(salida) as ingreso,sum(round(credit,2)) as credit from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_calcinacion.id) + """}',
			'{""" + str(parametros.location_virtual_produccion.id) + """,""" + str(parametros.location_existencias_calcinacion.id) + """}') 
			where (ubicacion_origen = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_destino = """ + str(parametros.location_existencias_calcinacion.id) + """)
			or (ubicacion_destino = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_origen = """ + str(parametros.location_existencias_calcinacion.id) + """)
			""")
	...
	def get_calci_ini_imp(self):
		...
		if len(periodo_anterior )>0:
			...
			self.env.cr.execute(""" 
				select saldov as ingreso,(round(credit,2)) as credit from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_calcinacion.id) + """}',
				'{""" + str(parametros.location_virtual_produccion.id) + """,""" + str(parametros.location_existencias_calcinacion.id) + """}') 
				where (ubicacion_origen = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_destino = """ + str(parametros.location_existencias_calcinacion.id) + """)
				or (ubicacion_destino = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_origen = """ + str(parametros.location_existencias_calcinacion.id) + """)
				""")
	...
	def get_calci_ven_ton(self):
		...
		var_txt_con = """ 
			select (salida) as ingreso,(round(credit,2)) as credit, ubicacion_destino, ubicacion_origen from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_calcinacion.id) + """}',
			'{"""
	...
	def get_micro_ini_imp(self):
		...
		if len(periodo_anterior )>0:
			...
			self.env.cr.execute(""" 
				select saldov as ingreso,(round(credit,2)) as credit from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_micronizado.id) + """}',
				'{""" + str(parametros.location_virtual_produccion.id) + """,""" + str(parametros.location_existencias_micronizado.id) + """}') 
				where (ubicacion_origen = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_destino = """ + str(parametros.location_existencias_micronizado.id) + """)
				or (ubicacion_destino = """ + str(parametros.location_virtual_produccion.id) + """ and ubicacion_origen = """ + str(parametros.location_existencias_micronizado.id) + """)
				""")
	...
	def get_micro_ven_ton(self):
		...
		var_txt_con = """ 
			select (salida) as ingreso,(round(credit,2)) as credit, ubicacion_destino,ubicacion_origen from get_kardex_v("""+fechaini+""","""+fechafin+""",'{""" + str(parametros.pproduct_costos_micronizado.id) + """}',
			'{"""
