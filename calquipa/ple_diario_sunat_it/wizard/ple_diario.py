...
CASE WHEN itd.code_sunat = 'CP' THEN '00' ELSE itd.code_sunat END END END as campo10,

CASE WHEN aj.register_sunat not in ('1','2') then NULL::text else
  CASE WHEN itd.code_sunat in ('05','50') THEN "substring"(am.dec_reg_nro_comprobante::text, 0, "position"(am.dec_reg_nro_comprobante::text, '-'::text)) ELSE
  		CASE WHEN itd.code_sunat = '10' THEN '1683' ELSE
  		CASE
...
'' as campo17,
aml.debit as campo18,
aml.credit as campo19,
