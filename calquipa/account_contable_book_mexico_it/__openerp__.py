# -*- encoding: utf-8 -*-
{
	...
	'category': 'account',
	'author': 'ITGrupo',
	'depends': ['account','account_voucher','account_tables_it','account_type_doc_it','currency_sunat_change_it','partner_name_it','finantial_convertion_it','account_contable_book_it'],
	'version': '1.0',
	'description':"""
