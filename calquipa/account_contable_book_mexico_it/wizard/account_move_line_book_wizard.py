...
class account_move_line_book_mexico_wizard(osv.TransientModel):
	_name='account.move.line.book.mexico.wizard'
	...
	libros = fields.Many2many('account.journal','account_book_journal_rel_mexico','id_book_origen','id_journal_destino', string='Libros', required=True)
