...
class Report(osv.Model):
    ...
    def get_pdf(self, cr, uid, ids, report_name, html=None, data=None, context=None):
        ...
        pdf_obj = open('E:\\OdooCalquipaOficial\\header.html','wb')
        pdf_obj.write(str(headerhtml))
        pdf_obj.close()

        pdf_obj = open('E:\\OdooCalquipaOficial\\footer.html','wb')
        pdf_obj.write(str(footerhtml))
        pdf_obj.close()


        pdf_obj = open('E:\\OdooCalquipaOficial\\content.html','wb')
        pdf_obj.write(str(contenthtml))
        pdf_obj.close()
