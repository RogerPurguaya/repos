# -*- encoding: utf-8 -*-
{
	...
	'category': 'account',
	'author': 'ITGrupo',
	'depends': ['stock_cancel','stock_account','web','sale','purchase_requisition','account','account_voucher','account_tables_it','account_type_doc_it','currency_sunat_change_it','partner_name_it','account_contable_book_it','repaccount_move_line_it'],
	'version': '1.0',
	'description':"""
