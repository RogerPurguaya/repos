    ...
    def create_analytic_lines(self, cr, uid, ids, context=None):
        ...
        for line in self.browse(cr, uid, ids, context=context):
           if line.analytics_id:
               ...
               total_linea = float("%0.2f"% ((line.credit or  0.0) - (line.debit or 0.0)))

               print "TOTAL LINEA", total_linea
               acum_linea = 0
               pos = 0
               tam_len = len(line.analytics_id.account_ids)
