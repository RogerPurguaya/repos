...
class account_analytic_book_major_mexico(models.Model):
	_name = 'account.analytic.book.major.mexico'
	_auto = False
...
class account_analytic_book_major_saldoinicial_mexico(models.Model):
	_name = 'account.analytic.book.major.saldoinicial.mexico'
