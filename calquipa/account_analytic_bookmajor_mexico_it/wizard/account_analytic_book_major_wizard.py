...
class account_analytic_book_major_mexico_wizard(osv.TransientModel):
	_name='account.analytic.book.major.mexico.wizard'
	...
	cuentas = fields.Many2many('account.account','account_book_major_account_rel_mexico','id_book_origen','id_account_destino', string='Cuentas', required=True)
