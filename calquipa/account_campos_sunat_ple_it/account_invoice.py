		...
		for inv in self:
			if inv.move_id.id:
				...
				if inv.tipo_sustento_credito_fiscasl:
					self._cr.execute(""" UPDATE account_move SET tipo_sustento_credito_fiscasl='%s' WHERE id=%s """%(inv.tipo_sustento_credito_fiscasl.id, inv.move_id.id))
				else:
				...
				if inv.serie_sustento_credito_fiscasl:
					self._cr.execute(""" UPDATE account_move SET serie_sustento_credito_fiscasl='%s' WHERE id=%s """%(inv.serie_sustento_credito_fiscasl.id, inv.move_id.id))
				else:
				...
				if inv.anio_sustento_credito_fiscasl:
					self._cr.execute(""" UPDATE account_move SET anio_sustento_credito_fiscasl='%s' WHERE id=%s """%(inv.anio_sustento_credito_fiscasl.id, inv.move_id.id))
				else:
				...
				if inv.nro_comp_sustento_credito_fiscasl:
					self._cr.execute(""" UPDATE account_move SET nro_comp_sustento_credito_fiscasl='%s' WHERE id=%s """%(inv.nro_comp_sustento_credito_fiscasl.id, inv.move_id.id))
				else:
