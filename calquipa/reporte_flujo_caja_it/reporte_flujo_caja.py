...
class reporte_flujo_caja_wizard(osv.TransientModel):
	...
	def do_rebuild(self):	
		...
		worksheet = workbook.add_worksheet(u"Flujo Caja Por Meses")
...
order by t2.group,t1.code) tt
	where (enero + febrero + marzo + abril + mayo + junio + julio + agosto + setiembre + octubre + noviembre + diciembre ) <> 0
...
and left(cuenta,2) != '10'
	  ...
	  """)
			...
			worksheet.write(x-1,0, u"CFE", bold)
			worksheet.write(x-1,3, u"ENERO", bold)
			worksheet.write(x-1,4, u"FEBRERO", bold)
			worksheet.write(x-1,5, u"MARZO", bold)
			worksheet.write(x-1,6, u"ABRIL", bold)
			worksheet.write(x-1,7, u"MAYO", bold)
			worksheet.write(x-1,8, u"JUNIO", bold)
			worksheet.write(x-1,9, u"JULIO", bold)
			worksheet.write(x-1,10, u"AGOSTO", bold)
			worksheet.write(x-1,11, u"SEPTIEMBRE", bold)
			worksheet.write(x-1,12, u"OCTUBRE", bold)
			worksheet.write(x-1,13, u"NOVIEMBRE", bold)
			worksheet.write(x-1,14, u"DICIEMBRE", bold)
			...
			for i in contenedor_ingreso:
				...
				worksheet.write(x,10, i[10], numberdos)
				worksheet.write(x,11, i[11], numberdos)
				worksheet.write(x,12, i[12], numberdos)
				worksheet.write(x,13, i[13], numberdos)
				worksheet.write(x,14, i[14], numberdos)
				x += 1
			...
			worksheet.write(x,10, contenedor_1[10], numberdosbold)
			worksheet.write(x,11, contenedor_1[11], numberdosbold)
			worksheet.write(x,12, contenedor_1[12], numberdosbold)
			worksheet.write(x,13, contenedor_1[13], numberdosbold)
			worksheet.write(x,14, contenedor_1[14], numberdosbold)
			...
			worksheet.write(x,10, contenedor_3[10], numberdosbold)
			worksheet.write(x,11, contenedor_3[11], numberdosbold)
			worksheet.write(x,12, contenedor_3[12], numberdosbold)
			worksheet.write(x,13, contenedor_3[13], numberdosbold)
			worksheet.write(x,14, contenedor_3[14], numberdosbold)
			...
			worksheet.write(x,10, contenedor_total_1a2[10], numberdosbold)
			worksheet.write(x,11, contenedor_total_1a2[11], numberdosbold)
			worksheet.write(x,12, contenedor_total_1a2[12], numberdosbold)
			worksheet.write(x,13, contenedor_total_1a2[13], numberdosbold)
			worksheet.write(x,14, contenedor_total_1a2[14], numberdosbold)
			x += 1
