...
class hr_certificado_trabajo_wizard(models.TransientModel):
	...
	def cabecera(self,c,wReal,hReal):
		...
		c.drawImage(direccion + 'calquipalright.png',70, hReal-20, width=120, height=50)
		c.drawImage(direccion + 'calquipalleft.png',380, hReal-35, width=140, height=70)
	...
	def reporteador(self):
		...
		for employee in self.employee_ids:
			for cont in range(2):
				...
				c.drawString( 70 , pos_inicial, u"A QUIEN CORRESPONDA:")
